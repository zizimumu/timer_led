...
#ifndef STM32F10X_CL
  RCC->CIR = 0x009F0000;				/* Disable all clock interrupts and clear pending bits  */
#else
...
// use external crystal as system input clock
#ifdef USE_HSE_CLOCK
...
#else
// use internal RC as system input clock
